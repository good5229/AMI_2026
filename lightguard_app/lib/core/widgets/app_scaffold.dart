...
class _GlossarySheet extends StatelessWidget {
  ...
  static const terms = <(String, String)>[
    ...
    ('조명 합산 정격용량', '선택 지역 또는 분전함에 연결된 조명의 정격용량을 모두 더한 값'),
    ...
    ('우선 확인 대상', '운전 기준과 다른 신호가 뚜렷해 담당자가 먼저 원격 확인할 분전함'),
    ('현장점검 검토 대상', '원격 확인 결과에 따라 현장점검 여부를 결정할 분전함'),
    ('추적 관찰 대상', '즉시 출동보다 다음 운전 주기의 신호 변화를 계속 살펴볼 분전함'),
  ];
